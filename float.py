...
for szam in tizedes_tort_lista:
    if szam.is_integer() and szam < 0:
        print(f'Ez az első negatív egész szám indexe: {tizedes_tort_lista.index(szam) + 1}')
        talalt = True
        break
...
if len(negativ_szamok) > 0:
    ...
    print(f'Ezen a helyen állt: {tizedes_tort_lista.index(max_negativ) + 1}')
